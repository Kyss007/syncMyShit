...
var Content = () => {
  ...
  const [showPaste, setShowPaste] = (0, import_react3.useState)(false);
  ...
  const startLogin = async () => {
    ...
    try {
      ...
      toaster.toast({ title: "Login failed", body: String(e?.message || e), duration: 5e3 });
    } finally {
      setBusyLogin(false);
    }
  };
  ...
  return /* @__PURE__ */ window.SP_REACT.createElement("div", { style: { paddingBottom: 12 } }, /* @__PURE__ */ window.SP_REACT.createElement(
    ...
    /* @__PURE__ */ window.SP_REACT.createElement("div", { style: { fontSize: 11, color: C.muted, lineHeight: 1.4 } }, authed ? "Saves land in Drive folder syncMyShit \u2014 same as Android." : waiting ? "Scan the QR. Sign in on your phone. Paste the localhost URL back." : "Scan the QR. Bribe Google. Sync your shit.")
  )), !authed && !waiting && /* @__PURE__ */ window.SP_REACT.createElement(import_ui.PanelSectionRow, null, /* @__PURE__ */ window.SP_REACT.createElement(import_ui.ButtonItem, { layout: "below", onClick: startLogin, disabled: busyLogin }, /* @__PURE__ */ window.SP_REACT.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "center", gap: 8 } }, /* @__PURE__ */ window.SP_REACT.createElement(FaGoogle, { size: 13 }), /* @__PURE__ */ window.SP_REACT.createElement("span", null, "Link Google Drive")))), waiting && lanUrl && /* @__PURE__ */ window.SP_REACT.createElement(window.SP_REACT.Fragment, null, /* @__PURE__ */ window.SP_REACT.createElement(import_ui.PanelSectionRow, null, /* @__PURE__ */ window.SP_REACT.createElement("div", { style: { width: "100%", textAlign: "center", padding: "8px 0" } }, /* @__PURE__ */ window.SP_REACT.createElement(
    "img",
    {
    ...
    /* @__PURE__ */ window.SP_REACT.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "center", gap: 6 } }, /* @__PURE__ */ window.SP_REACT.createElement(FaKey, { size: 11 }), /* @__PURE__ */ window.SP_REACT.createElement("span", null, showPaste ? "Hide paste field" : "Paste code on Deck instead"))
  )), showPaste && /* @__PURE__ */ window.SP_REACT.createElement(window.SP_REACT.Fragment, null, /* @__PURE__ */ window.SP_REACT.createElement(import_ui.PanelSectionRow, null, /* @__PURE__ */ window.SP_REACT.createElement(
    import_ui.TextField,
    {
      label: "Auth URL / code",
      value: manualCode,
