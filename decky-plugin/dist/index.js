...
var apiStartLogin = callable("start_login");
var apiCancelLogin = callable("cancel_login");
var apiSubmitCode = callable(
  "submit_code"
);
...
async function makeQrSvg(data) {
  return import_qrcode.default.toString(data, {
    type: "svg",
...
var Content = () => {
  ...
  const [lanUrl, setLanUrl] = (0, import_react3.useState)("");
  const [qrSvg, setQrSvg] = (0, import_react3.useState)("");
  const [loginError, setLoginError] = (0, import_react3.useState)("");
  ...
  const [busyLogin, setBusyLogin] = (0, import_react3.useState)(false);
  const [backendOk, setBackendOk] = (0, import_react3.useState)(true);
  const [version, setVersion] = (0, import_react3.useState)("?");
  const autoStarted = (0, import_react3.useRef)(false);
  const setLanAndQr = (0, import_react3.useCallback)(async (url) => {
    setLanUrl(url);
    if (!url) {
      setQrSvg("");
      return;
  ...
  const startLogin = (0, import_react3.useCallback)(async (silent = false) => {
    setBusyLogin(true);
    setLoginError("");
    try {
      ...
      if (res.success && res.lan_url) {
        ...
        setWaiting(false);
        if (!silent) {
          toaster.toast({ title: "Login failed", body: err, duration: 6e3 });
        }
      }
    } catch (e) {
  ...
  const submitManual = async () => {
    ...
    try {
      ...
      if (res.success) {
        ...
        setWaiting(false);
        await setLanAndQr("");
        toaster.toast({ title: "Drive linked", body: res.email || "Connected", duration: 4e3 });
        await refresh();
      } else {
        toaster.toast({ title: "Code rejected", body: res.error || "Try again", duration: 5e3 });
      }
    } catch (e) {
      toaster.toast({ title: "Code rejected", body: String(e?.message || e), duration: 5e3 });
    }
  };
  const doSync = async (id) => {
    if (!authed) {
      toaster.toast({ title: "Sign in first", body: "Link Google Drive to sync.", duration: 4e3 });
      return;
    }
    setSyncing(true);
  ...
  const signOut = async () => {
    try {
      ...
      toaster.toast({ title: "Signed out", body: "Google Drive disconnected", duration: 3e3 });
      await refresh();
      await startLogin(true);
    } catch (_) {
    }
  ...
  return /* @__PURE__ */ window.SP_REACT.createElement("div", { style: { paddingBottom: 12 } }, /* @__PURE__ */ window.SP_REACT.createElement(
    ...
    /* @__PURE__ */ window.SP_REACT.createElement("div", { style: { fontSize: 11, color: C.muted, marginTop: 4, lineHeight: 1.35 } }, "Deck \u2194 Phone \u2194 Drive. Zero save drama.")
    ...
    /* @__PURE__ */ window.SP_REACT.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8, marginBottom: 4 } }, authed ? /* @__PURE__ */ window.SP_REACT.createElement(FaCheckCircle, { color: C.lime, size: 14 }) : waiting ? /* @__PURE__ */ window.SP_REACT.createElement(FaSyncAlt, { className: "fa-spin", color: C.warn, size: 14 }) : /* @__PURE__ */ window.SP_REACT.createElement(FaExclamationCircle, { color: C.coral, size: 14 }), /* @__PURE__ */ window.SP_REACT.createElement(
      "span",
      {
        style: {
          fontWeight: 700,
    ...
    /* @__PURE__ */ window.SP_REACT.createElement("div", { style: { fontSize: 11, color: C.muted, lineHeight: 1.4 } }, authed ? "Saves land in Drive folder syncMyShit \u2014 same as Android." : "1) Scan QR  2) Google on phone  3) Paste the 127.0.0.1 URL back on phone"),
    !backendOk && /* @__PURE__ */ window.SP_REACT.createElement("div", { style: { marginTop: 8, fontSize: 11, color: C.coral } }, "Backend error: ", loginError || "unknown"),
    loginError && backendOk && /* @__PURE__ */ window.SP_REACT.createElement("div", { style: { marginTop: 8, fontSize: 11, color: C.coral } }, loginError)
  )), showLoginPanel && /* @__PURE__ */ window.SP_REACT.createElement(window.SP_REACT.Fragment, null, (qrSvg || lanUrl) && /* @__PURE__ */ window.SP_REACT.createElement(import_ui.PanelSectionRow, null, /* @__PURE__ */ window.SP_REACT.createElement("div", { style: { width: "100%", textAlign: "center", padding: "8px 0" } }, qrSvg ? /* @__PURE__ */ window.SP_REACT.createElement(
    "div",
    {
      style: {
  ...
  ) : /* @__PURE__ */ window.SP_REACT.createElement("div", { style: { color: C.warn, fontSize: 12, padding: 12 } }, "QR rendering failed \u2014 use the URL below on your phone browser."), /* @__PURE__ */ window.SP_REACT.createElement(
    "div",
    {
      style: {
        marginTop: 10,
    ...
    lanUrl || "\u2026"
  ), /* @__PURE__ */ window.SP_REACT.createElement("div", { style: { marginTop: 6, fontSize: 11, color: C.muted } }, "Phone must be on the same Wi\u2011Fi as the Deck"))), !lanUrl && /* @__PURE__ */ window.SP_REACT.createElement(import_ui.PanelSectionRow, null, /* @__PURE__ */ window.SP_REACT.createElement(import_ui.ButtonItem, { layout: "below", onClick: () => startLogin(false), disabled: busyLogin }, /* @__PURE__ */ window.SP_REACT.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "center", gap: 8 } }, /* @__PURE__ */ window.SP_REACT.createElement(FaGoogle, { size: 13 }), /* @__PURE__ */ window.SP_REACT.createElement("span", null, busyLogin ? "Starting\u2026" : "Show login QR")))), lanUrl && /* @__PURE__ */ window.SP_REACT.createElement(window.SP_REACT.Fragment, null, /* @__PURE__ */ window.SP_REACT.createElement(import_ui.PanelSectionRow, null, /* @__PURE__ */ window.SP_REACT.createElement(
    ...
    /* @__PURE__ */ window.SP_REACT.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "center", gap: 6 } }, /* @__PURE__ */ window.SP_REACT.createElement(FaCopy, { size: 12 }), /* @__PURE__ */ window.SP_REACT.createElement("span", null, "Copy login link"))
  )), /* @__PURE__ */ window.SP_REACT.createElement(import_ui.PanelSectionRow, null, /* @__PURE__ */ window.SP_REACT.createElement(import_ui.ButtonItem, { layout: "below", onClick: () => startLogin(false), disabled: busyLogin }, /* @__PURE__ */ window.SP_REACT.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "center", gap: 6 } }, /* @__PURE__ */ window.SP_REACT.createElement(FaSyncAlt, { size: 12 }), /* @__PURE__ */ window.SP_REACT.createElement("span", null, "Refresh QR")))), /* @__PURE__ */ window.SP_REACT.createElement(import_ui.PanelSectionRow, null, /* @__PURE__ */ window.SP_REACT.createElement(import_ui.ButtonItem, { layout: "below", onClick: cancelLogin }, /* @__PURE__ */ window.SP_REACT.createElement("div", { style: { display: "flex", alignItems: "center", justifyContent: "center", gap: 6 } }, /* @__PURE__ */ window.SP_REACT.createElement(FaTimes, { size: 12 }), /* @__PURE__ */ window.SP_REACT.createElement("span", null, "Cancel"))))), /* @__PURE__ */ window.SP_REACT.createElement(import_ui.PanelSectionRow, null, /* @__PURE__ */ window.SP_REACT.createElement(
    import_ui.TextField,
    {
